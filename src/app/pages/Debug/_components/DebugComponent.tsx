...
const DATA_SETS: DataSet[] = [
  ...
  { name: "Sea Creatures", data: seaCreatureIcons },
  { name: "Songs", data: songData },
  {
    name: "Sound Effects",
    data: Object.entries(soundEffects).reduce(
      (acc, [key, value]) => {
        acc[key] = {
        ...
        {filteredDataSets.map((dataSet, index) => {
          ...
          return (
            <button
              ...
              disabled={isEmpty}
              css={[styles.tab, isActive && styles.tabActive, isEmpty && styles.tabDisabled]}
            >
                ...
                <Card key={key} css={styles.dataItem}>
                  ...
                  {value?.audioUrl && (
                    <button
                      ...
                      aria-label={
                        playingAudioUrl === value?.audioUrl ? "Pause audio" : "Play audio"
                      }
                    >
